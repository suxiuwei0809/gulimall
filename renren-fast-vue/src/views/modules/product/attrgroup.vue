<template>
  <el-row :gutter="20">
    <el-col :span="6"><div class="grid-content bg-purple"> <category @tree-node-click="treeNodeClick"></category></div></el-col>
    <el-col :span="18"><div class="grid-content bg-purple"> <div class="mod-config">
